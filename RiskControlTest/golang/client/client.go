...
import (
	...
	alipayutil "gitlab.alibaba-inc.com/alicloud-sdk/alipaycloud/util/golang/service"
)
...
type RiskSwitchInfo struct {
	BizOp         *string `json:"biz_op" xml:"biz_op"`
	BizTag        *string `json:"biz_tag" xml:"biz_tag"`
	ErrorMsg      *string `json:"error_msg" xml:"error_msg"`
	Group         *string `json:"group" xml:"group"`
	Id            *string `json:"id" xml:"id"`
	SecRequestUrl *string `json:"sec_request_url" xml:"sec_request_url"`
...
type NotifyRiskRequest struct {
	BizOp      *string           `json:"biz_op" xml:"biz_op"`
	BizResult  *bool             `json:"biz_result" xml:"biz_result"`
	BizTag     *string           `json:"biz_tag" xml:"biz_tag"`
	ExtParams  []*ExtraParamInfo `json:"ext_params" xml:"ext_params" type:"Repeated"`
	OperatorId *string           `json:"operator_id" xml:"operator_id"`
	SecurityId *string           `json:"security_id" xml:"security_id"`
	Tenant     *string           `json:"tenant" xml:"tenant"`
}
...
type QueryRiskSwitchResponse struct {
	RiskSwitchInfo []*RiskSwitchInfo `json:"risk_switch_info" xml:"risk_switch_info" type:"Repeated"`
}
...
type AddBizpunishResponse struct {
	ActionResult *bool   `json:"action_result" xml:"action_result"`
	RequestId    *string `json:"request_id" xml:"request_id"`
}
...
type AnalyzeContentriskRequest struct {
	AppMainScene   *string   `json:"app_main_scene" xml:"app_main_scene" maxLength:"0"`
	AppMainSceneId *string   `json:"app_main_scene_id" xml:"app_main_scene_id" maxLength:"0"`
	AppName        *string   `json:"app_name" xml:"app_name" maxLength:"0"`
	AppScene       *string   `json:"app_scene" xml:"app_scene" maxLength:"0"`
	AppSceneDataId *string   `json:"app_scene_data_id" xml:"app_scene_data_id" maxLength:"0"`
	AudioUrls      []*string `json:"audio_urls" xml:"audio_urls" maxLength:"0" type:"Repeated"`
	LinkUrls       []*string `json:"link_urls" xml:"link_urls" maxLength:"0" type:"Repeated"`
	OperatorId     *string   `json:"operator_id" xml:"operator_id"`
	PictureUrls    []*string `json:"picture_urls" xml:"picture_urls" maxLength:"0" type:"Repeated"`
	PublishDate    *string   `json:"publish_date" xml:"publish_date" maxLength:"0" pattern:"\\d{4}[-]\\d{1,2}[-]\\d{1,2}(\\s\\d{2}:\\d{2}(:\\d{2})?)?"`
	Tenant         *string   `json:"tenant" xml:"tenant"`
	Text           *string   `json:"text" xml:"text" maxLength:"0"`
	VideoUrls      []*string `json:"video_urls" xml:"video_urls" maxLength:"0" type:"Repeated"`
}
...
type AnalyzeContentriskResponse struct {
	AppSceneDataId *string `json:"app_scene_data_id" xml:"app_scene_data_id" maxLength:"0"`
	EventId        *string `json:"event_id" xml:"event_id" maxLength:"0"`
	NeedQuery      *string `json:"need_query" xml:"need_query" maxLength:"0"`
	Reason         *string `json:"reason" xml:"reason" maxLength:"0"`
	ResultAction   *string `json:"result_action" xml:"result_action" maxLength:"0"`
}
...
type ConfirmRiskResponse struct {
	ConfirmSuccess *bool `json:"confirm_success" xml:"confirm_success"`
}
...
type QueryRiskRequest struct {
	...
	ExtParams   []*ExtraParamInfo `json:"ext_params" xml:"ext_params" type:"Repeated"`
	LoginName   *string           `json:"login_name" xml:"login_name"`
	OperatorId  *string           `json:"operator_id" xml:"operator_id"`
	ServerName  *string           `json:"server_name" xml:"server_name"`
	Tenant      *string           `json:"tenant" xml:"tenant"`
	TokenId     *string           `json:"token_id" xml:"token_id"`
...
type QueryRiskResponse struct {
	SecurityId   *string `json:"security_id" xml:"security_id"`
	SecResult    *string `json:"sec_result" xml:"sec_result"`
	TemplateCode *string `json:"template_code" xml:"template_code"`
	TemplateDesc *string `json:"template_desc" xml:"template_desc"`
	VerifyId     *string `json:"verify_id" xml:"verify_id"`
	VerifyUrl    *string `json:"verify_url" xml:"verify_url"`
}
...
type QueryContentriskResultRequest struct {
	AppScene       *string `json:"app_scene" xml:"app_scene"`
	AppSceneDataId *string `json:"app_scene_data_id" xml:"app_scene_data_id"`
...
type QueryContentriskResultResponse struct {
	Reason       *string `json:"reason" xml:"reason"`
	ResultAction *string `json:"result_action" xml:"result_action"`
}
	...
	for _retryTimes := 0; tea.AllowRetry(_runtime["retry"], _retryTimes); _retryTimes++ {
		...
		_resp, _err = func() (map[string]interface{}, error) {
			...
			request_.Query = map[string]string{
				"method":     tea.StringValue(action),
				"version":    "1.0",
				"sign_type":  "HmacSHA1",
				"req_time":   tea.StringValue(alipayutil.GetTimestamp()),
				"req_msg_id": tea.StringValue(util.GetNonce()),
			}
			if !tea.BoolValue(util.Empty(client.Tenant)) {
				request_.Query["tenant"] = tea.StringValue(client.Tenant)
			}

			if !tea.BoolValue(util.Empty(client.Workspace)) {
				request_.Query["workspace"] = tea.StringValue(client.Workspace)
			}

			if !tea.BoolValue(util.Empty(client.AuthToken)) {
				request_.Query["auth_token"] = tea.StringValue(client.AuthToken)
			} else {
				request_.Query["access_key"] = tea.StringValue(client.AccessKeyId)
			}
			...
			request_.Query["sign"] = tea.StringValue(alipayutil.GetSignature(signedParam, client.AccessKeySecret))
